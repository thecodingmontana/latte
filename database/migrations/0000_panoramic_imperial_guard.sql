...
--> statement-breakpoint
CREATE TABLE "app_passkey_credential" (
...
CREATE TABLE "app_totp_credential" (
	...
	"created_at" timestamp (3) with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp (3) with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "app_totp_credential_user_id_unique" UNIQUE("user_id")
);
--> statement-breakpoint
...
ALTER TABLE "app_passkey_credential" ADD CONSTRAINT "app_passkey_credential_user_id_app_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."app_user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "app_totp_credential" ADD CONSTRAINT "app_totp_credential_user_id_app_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."app_user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
